...
public class Dialogos {
	...
	private void initialize() {
		...
		JLabel lblMensaje = new JLabel("Selecciona una opción.");
		
		JButton btnInfo = new JButton("Informaci\u00F3n");
		btnInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				JOptionPane.showMessageDialog(frame, "Mensaje de información.");
			}
		});
		...
		btnConf.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int n = JOptionPane.showConfirmDialog(frame, "¿Quieres destruir el mundo?", "Una decisión vital.", JOptionPane.YES_NO_CANCEL_OPTION);
				switch (n) {
					case JOptionPane.YES_OPTION:
						lblMensaje.setText("Bomba atómica lanzada.");
						break;
					case JOptionPane.NO_OPTION:
						lblMensaje.setText("La mejor opción.");
						break;
					case JOptionPane.CANCEL_OPTION:
						lblMensaje.setText("Quizás en otro momento.");
						break;
					default:
						lblMensaje.setText("Operación abortada");
				}
			}
		});
		...
		btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Object[] option = {"Sí, quiero.", "No, mala idea", "No sé"};
		...
		btnLista.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Object[] posibilidades = {"Meteorito", "Plaga", "Invasión"};
				String cadena = (String)JOptionPane.showInputDialog(
						frame, 
						"Tipos de ataque.", 
						"¿Cómo quieres destruir el mundo?", 
				...
				if((cadena != null)&&(cadena.length()>0)) {
					lblMensaje.setText("Destrucción con " + cadena + ".");
				}
			}
		});
