    ...
    public static void sumar10impares(Scanner teclado) {
        ...
        while (true) {
            try {
                ...
                System.out.println("\n\tLos 10 primeros numeros impares son " + cadena + ", y su producto es " + suma + ".");
                break;
            } catch (NumberFormatException e) {
                System.out.println("\n\tError: Introduce un numero entero.");
                teclado.nextLine();
        ...
        while (true) {
            try {
                ...
                MiClase.menu (new String [] {
                    ...
                    "\t-> Hay " + mayor175 + " alumnos que miden mas de 1.75 m."
                });
                break;
            } catch (NumberFormatException e) {
                System.out.println("\n\tError: Introduce un numero entero.");
        ...
        while (true) {
            try {
                ...
                MiClase.menu (new String[] {
                    ...
                    "13. Calcular factorial de un numero.",
                    ...
                    "16. Dadas las edades y alturas de 5 alumnos, mostrar la edad y la estatura media, la cantidad de alumnos mayores de 18, y la cantidad de alumnos que miden mas de 1.75.",
