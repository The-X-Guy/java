...
public class Recursividad {
    ...
    public static void visualizarNaturales (Scanner teclado) {
        ...
        while (true) {
            try {
                ...
                ClaseRecursividad.ShowNaturales(numero);
                break;
            } catch (NumberFormatException e) {
                System.out.println("Error: Introduce un numero entero.");
                teclado.nextLine();
    ...
    public static void visualizarNaturalesInvertidos (Scanner teclado) {
        ...
        while (true) {
            try {
                ...
                ClaseRecursividad.ShowInvNaturales(numero);
                break;
            } catch (NumberFormatException e) {
                System.out.println("Error: Introduce un numero entero.");
                teclado.nextLine();
    ...
    public static void imprimirCifras (Scanner teclado) {
        MiClase.clearScreen();
        ...
        while (true) {
            try {
                System.out.print("\n\tIntroduce un numero: ");
                int numero = teclado.nextInt();
                System.out.println("\n\tLas cifras del numero son:");
                ClaseRecursividad.cifrasLinea(numero);
                break;
            } catch (NumberFormatException e) {
                System.out.println("Error: Introduce un numero entero.");
                teclado.nextLine();
    ...
    public static void NaturalInvertido (Scanner teclado) {
        MiClase.clearScreen();
        System.out.println("6. Método para visualizar un numero natural invertido.");
        while (true) {
            try {
                System.out.print("\n\tIntroduce un numero: ");
                int numero = teclado.nextInt();
                System.out.println("\n\tEl numero invertido es: ");
                ClaseRecursividad.Invertir(numero);
                break;
            } catch (NumberFormatException e) {
                System.out.println("Error: Introduce un numero entero.");
                teclado.nextLine();
    ...
    public static void sumarCifras (Scanner teclado) {
        ...
        while (true) {
            try {
                System.out.print("\n\tIntroduce el numero: ");
                int numero = teclado.nextInt();
                int suma = ClaseRecursividad.sumarCifras(numero);
    ...
    public static void calcularDivision (Scanner teclado) {
        ...
        while (true) {
            try {
                ...
                int resultado = ClaseRecursividad.divisionRestas(dividendo, divisor);
                System.out.println("\n\tEl resultado de " + dividendo + "/" + divisor + " es " + resultado + ".");
                ...
                if (opcion < 0 || opcion > 13) {
                    ...
                    switch (opcion) {
                        ...
                        case 5: 
                            ...
                            break;
                        case 6:
                            NaturalInvertido(teclado);
                            break;
                        case 7:
                            imprimirCifras(teclado);
                            break;
                        case 8:
